    ...
    angular
        ...
        .config(function($translateProvider) {
            ...
            $translateProvider.translations('en', {
                ...
                NEPOLOZENI_PREDMET_ESPB: 'espb',
                NEPOLOZENI_PREDMET_ID: 'id',
                NEPOLOZENI_PREDMET_IME_PROFESORA: 'ime profesora',
                NEPOLOZENI_PREDMET_NAZIV: 'naziv',
                NEPOLOZENI_PREDMET_OBAVEZNI: 'obavezni',
                NEPOLOZENI_PREDMET_PREDLOZENI_SEMESTAR: 'predlozeni semestar',
                NEPOLOZENI_PRIJAVI: 'Prijavi',
                NEPOLOZENI_SEMESTAR_PRVOG_SLUSANJA: 'Prvi put slusan semestar',
                NESLUSANI_PREDMET_ESPB: 'espb',
                NESLUSANI_PREDMET_ID: 'id',
                NESLUSANI_PREDMET_IME_PROFESORA: 'Ime profesora',
                NESLUSANI_PREDMET_NAZIV: 'Naziv',
                NESLUSANI_PREDMET_OBAVEZNI: 'obavezni',
                NESLUSANI_PREDMET_PREDLOZENI_SEMESTAR: 'Predlozeni semestar',
                NESLUSANI_SEMESTAR_PRVOG_SLUSANJA: 'Semestar prvog slusanja',
                NESLUSANI_SLUSAJ: 'Zahtev za slusanje',
                NO: 'No',
                OK: 'Ok',
                PLEASE_SELECT: 'Please select',
                POLOZENI_DATUM_POLOZENO: 'Datum polozeno',
                POLOZENI_OCENA: 'Ocena',
                POLOZENI_PREDMET_ESPB: ' espb',
                POLOZENI_PREDMET_ID: ' id',
                POLOZENI_PREDMET_IME_PROFESORA: ' ime profesora',
                POLOZENI_PREDMET_NAZIV: ' naziv',
                POLOZENI_PREDMET_OBAVEZNI: ' obavezni',
                ...
                PRIJAVLJENI_PREDMET_PREDLOZENI_SEMESTAR: 'predlozeni semestar',
