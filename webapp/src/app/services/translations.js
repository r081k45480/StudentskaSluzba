    ...
    angular
        ...
        .config(function($translateProvider) {
            ...
            $translateProvider.translations('en', {
                ...
                NESLUSANI_DATUM_POLOZENO: 'Datum polozeno',
                NESLUSANI_ID: 'Id',
                NESLUSANI_OCENA: 'Ocena',
                NESLUSANI_PREDMET_ID: 'Predmet id',
                NESLUSANI_SEMESTAR_POSLEDNJE_SLUSANJA: 'Semestar poslednje slusanja',
                NESLUSANI_SEMESTAR_PRVOG_SLUSANJA: 'Semestar prvog slusanja',
                NESLUSANI_SLUSAJ: 'Slusaj',
                NESLUSANI_STUDENT_ID: 'Student id',
                NO: 'No',
                OK: 'Ok',
                ...
                POLOZENI_SEMESTAR_POSLEDNJE_SLUSANJA: 'Semestar poslednje slusanja',
                POLOZENI_SEMESTAR_PRVOG_SLUSANJA: 'Semestar prvog slusanja',
                POLOZENI_STUDENT_ID: 'Student id',
                PREDMETI_PAGE_NEPOLOZENI: 'Nepolozeni',
                PREDMETI_PAGE_NESLUSANI: 'Neslusani',
                PREDMETI_PAGE_POLOZENI: 'Polozeni',
                PRIJAVLJENI_DATUM_POLOZENO: 'Datum polozeno',
                PRIJAVLJENI_ID: 'Id',
                PRIJAVLJENI_OCENA: 'Ocena',
                PRIJAVLJENI_PREDMET_ID: 'Predmet id',
                PRIJAVLJENI_SEMESTAR_POSLEDNJE_SLUSANJA: 'Semestar poslednje slusanja',
                PRIJAVLJENI_SEMESTAR_PRVOG_SLUSANJA: 'Semestar prvog slusanja',
                PRIJAVLJENI_STUDENT_ID: 'Student id',
