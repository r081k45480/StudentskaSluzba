...
public class CreateStudPredRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CreateStudPredRequest other = (CreateStudPredRequest) obj;
    ...
    public String toString() {
        return "CreateStudPredRequest[" + "studentId=" + studentId + ", predmetId=" + predmetId + ", ocena=" + ocena + ", datumPolozeno=" + datumPolozeno + ", semestarPrvogSlusanja="
