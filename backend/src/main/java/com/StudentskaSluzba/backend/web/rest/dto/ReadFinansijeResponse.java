...
public class ReadFinansijeResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ReadFinansijeResponse other = (ReadFinansijeResponse) obj;
    ...
    public String toString() {
        return "ReadFinansijeResponse[" + "id=" + id + ", studentId=" + studentId + ", iznos=" + iznos + ", opis=" + opis + ", prethodnoStanje=" + prethodnoStanje + ", datum=" + datum + "]";
    }
