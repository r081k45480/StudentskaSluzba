...
public class ReadStudentResponse implements Serializable {
    ...
    public ReadStudentResponse(Long id, String ime, String prezime, String index, BigDecimal trenutnoStanjeRacuna, Boolean budzet, Integer tekuciSemestar, Integer osvojeniBodovi) {
        this.id = id;
        this.ime = ime;
