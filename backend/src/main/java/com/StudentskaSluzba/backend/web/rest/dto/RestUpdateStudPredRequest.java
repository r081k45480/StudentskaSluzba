...
public class RestUpdateStudPredRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RestUpdateStudPredRequest other = (RestUpdateStudPredRequest) obj;
    ...
    public String toString() {
        return "RestUpdateStudPredRequest[" + "studentId=" + studentId + ", predmetId=" + predmetId + ", ocena=" + ocena + ", datumPolozeno=" + datumPolozeno + ", semestarPrvogSlusanja="
