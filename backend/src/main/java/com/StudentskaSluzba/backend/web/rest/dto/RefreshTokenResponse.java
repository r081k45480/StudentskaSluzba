...
public class RefreshTokenResponse implements Serializable {
    ...
    public RefreshTokenResponse(String accessToken, String refreshToken, Long id, String ime, String prezime, String index, BigDecimal trenutnoStanjeRacuna, Boolean budzet, Integer tekuciSemestar,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RefreshTokenResponse other = (RefreshTokenResponse) obj;
    ...
    public String toString() {
        return "RefreshTokenResponse[" + "id=" + id + ", ime=" + ime + ", prezime=" + prezime + ", index=" + index + ", trenutnoStanjeRacuna=" + trenutnoStanjeRacuna + ", budzet=" + budzet
