...
public class PrijavljeniPredmetiResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PrijavljeniPredmetiResponse other = (PrijavljeniPredmetiResponse) obj;
    ...
    public String toString() {
        return "PrijavljeniPredmetiResponse[" + "predmetNaziv=" + predmetNaziv + ", predmetEspb=" + predmetEspb + ", predmetObavezni=" + predmetObavezni + ", predmetPredlozeniSemestar="
                + predmetPredlozeniSemestar + ", predmetImeProfesora=" + predmetImeProfesora + ", semestarPrvogSlusanja=" + semestarPrvogSlusanja + "]";
    }
