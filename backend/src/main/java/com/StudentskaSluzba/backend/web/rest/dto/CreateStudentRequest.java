...
public class CreateStudentRequest implements Serializable {
    ...
    public CreateStudentRequest(String ime, String prezime, String index, BigDecimal trenutnoStanjeRacuna, Boolean budzet, Integer tekuciSemestar, Integer osvojeniBodovi, UserRole role,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final CreateStudentRequest other = (CreateStudentRequest) obj;
    ...
    public String toString() {
        return "CreateStudentRequest[" + "ime=" + ime + ", prezime=" + prezime + ", index=" + index + ", trenutnoStanjeRacuna=" + trenutnoStanjeRacuna + ", budzet=" + budzet + ", tekuciSemestar="
