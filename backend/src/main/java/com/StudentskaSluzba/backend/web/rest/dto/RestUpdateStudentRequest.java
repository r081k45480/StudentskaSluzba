...
public class RestUpdateStudentRequest implements Serializable {
    ...
    public RestUpdateStudentRequest(String ime, String prezime, String index, BigDecimal trenutnoStanjeRacuna, Boolean budzet, Integer tekuciSemestar, Integer osvojeniBodovi) {
        this.ime = ime;
