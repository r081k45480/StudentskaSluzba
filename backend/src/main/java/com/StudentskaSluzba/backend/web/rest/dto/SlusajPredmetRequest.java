...
public class SlusajPredmetRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final SlusajPredmetRequest other = (SlusajPredmetRequest) obj;
    ...
    public String toString() {
        return "SlusajPredmetRequest[" + "userId=" + userId + ", predmetId=" + predmetId + "]";
    }
