...
public class RestUpdateFinansijeRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RestUpdateFinansijeRequest other = (RestUpdateFinansijeRequest) obj;
    ...
    public String toString() {
        return "RestUpdateFinansijeRequest[" + "studentId=" + studentId + ", iznos=" + iznos + ", opis=" + opis + ", prethodnoStanje=" + prethodnoStanje + ", datum=" + datum + "]";
    }
