...
public class CreateStudPredResponse implements Serializable {
    ...
    public CreateStudPredResponse() {
    }

    public CreateStudPredResponse(Long id, Long studentId, Long predmetId) {
        this.id = id;
    ...
    public String toString() {
        return "CreateStudPredResponse[" + "id=" + id + ", studentId=" + studentId + ", predmetId=" + predmetId + "]";
    }
