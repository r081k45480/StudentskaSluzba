...
public class UpdateFinansijeResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UpdateFinansijeResponse other = (UpdateFinansijeResponse) obj;
    ...
    public String toString() {
        return "UpdateFinansijeResponse[" + "id=" + id + ", studentId=" + studentId + ", iznos=" + iznos + ", opis=" + opis + ", prethodnoStanje=" + prethodnoStanje + ", datum=" + datum + "]";
    }
