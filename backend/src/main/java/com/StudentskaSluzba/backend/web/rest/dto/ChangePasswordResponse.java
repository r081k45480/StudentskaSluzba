...
public class ChangePasswordResponse implements Serializable {
    ...
    public ChangePasswordResponse(Long id, String ime, String prezime, String index, BigDecimal trenutnoStanjeRacuna, Boolean budzet, Integer tekuciSemestar, Integer osvojeniBodovi, UserRole role,
            String username) {
        this.id = id;
        this.ime = ime;
