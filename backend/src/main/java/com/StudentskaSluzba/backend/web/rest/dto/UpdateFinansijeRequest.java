...
public class UpdateFinansijeRequest implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UpdateFinansijeRequest other = (UpdateFinansijeRequest) obj;
    ...
    public String toString() {
        return "UpdateFinansijeRequest[" + "id=" + id + ", studentId=" + studentId + ", iznos=" + iznos + ", opis=" + opis + ", prethodnoStanje=" + prethodnoStanje + ", datum=" + datum + "]";
    }
