...
public class ReadStudPredResponse implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ReadStudPredResponse other = (ReadStudPredResponse) obj;
    ...
    public String toString() {
        return "ReadStudPredResponse[" + "id=" + id + ", studentId=" + studentId + ", predmetId=" + predmetId + ", ocena=" + ocena + ", datumPolozeno=" + datumPolozeno + ", semestarPrvogSlusanja="
